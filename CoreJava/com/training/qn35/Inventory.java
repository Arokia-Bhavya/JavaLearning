...
public class Inventory {
	...
	public static void main(String[] args) {
		...
		scan.close();
		calculateProfit(noOfDozens,costPerDozen, sellingPrice);
	}

	private static void calculateProfit(int dozenCount,int costPerDozen, int sellingPrice) {
